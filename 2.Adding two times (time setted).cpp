//Create a class named time with data members hours, minutes and second. Use member function settime() to set time, gettime() to read time from user , add_time() to add two time and showtime() to display time in HH::MM::SS format.
#include<iostream>
using namespace std;
class   Time
{
